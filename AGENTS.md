...
- 全书尺度质量特性（声音锚定 anchor / voice-seed 冷启动 / 弧线账本 planning/arcs/ / 跨章重复检测）的作者用法见 `docs/literary-quality-reference.md` 的 "Book-scale quality features" 一节；token 预算单源在 `app/novel_forge/planning_spec.py`。
