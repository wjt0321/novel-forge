...
LITERARY_MICRO_RULES_VERSION = "literary-micro-rules/v4"
LITERARY_MICRO_RULES: dict[str, tuple[str, ...]] = {
    "writer": (
        "可以写：人物在具体压力下主动选择并付出具体私人代价；让劳动、身体、物件和位置的变化持续推动关系与下一步行动。",
        "慎写：精确数字、术语、比喻、母题和完美证据链；只有它们改变决定、限制、风险或后果时才保留。",
        "允许：误判、迟疑、沉默、反应迟半拍、不对称对白和未解释余波；人物不必聪明、整齐或立即理解一切。",
        "绝对禁止：把规划、审稿、因果清单或主题翻译成说明段；禁用机械三连、连续否定翻转、控制面语言和解释性修补，不得漂移用户硬锚或用好奇和事后补救冒充主动选择。",
    ),
    "blind-reader": (
        "可以认可：人物欲望是否进入动作、关系和代价，且形成具体私人代价；身体、物件和位置连续，读完想追问人物怎样承担后果。",
        "慎判：专业、精确、强钩子、漂亮句子和完美证据链可能只是技术表演；警惕漂亮结论替代现场余波，核对人物去掉姓名职业后是否仍不可替换。",
        "允许：克制、留白、误判、沉默、不对称对白和不整齐节奏；没解释完整不等于写错。",
        "绝对不能 pass：主角无主动选择、物理状态矛盾、正文像规划答卷，或控制面语言、机械语和解释性修补进入正文。",
    ),
    "chapter-editor": (
        "可以保留：偏离规划但增强人物、因果、关系或收束的现场发现；说明收益、代价与新增风险。",
        "慎审：完美证据链、因果跳步、机械精确、连续同主语、职业证明和过度修补；核对不对称关系、物理可行性与知识来源。",
        "允许：人物不知道、说错、犹豫、沉默和留白；Scene Package 只能发现缺失，不能证明正文已经交付。",
        "绝对禁止通过：用户硬锚合同优先于 Scene Package；用户硬锚漂移，或时间方向、金额或数量、物件位置、人物知识来源及身体状态不一致；解释性修补不能代替因果。",
    ),
}
