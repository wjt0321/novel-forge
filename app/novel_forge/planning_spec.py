...
LITERARY_MICRO_RULES_VERSION = "literary-micro-rules/v3"
LITERARY_MICRO_RULES: dict[str, tuple[str, ...]] = {
    "writer": (
        "可以写：人物误判、迟疑、遮掩、反应迟半拍；让欲望进入动作、关系变化和具体私人代价。",
        "慎写：精确数字、完美证据链、职业术语和连续同主语句；只有改变动作、限制、风险或后果才保留。",
        "允许：信息不完整、话不说尽、判断暂时错误、行动留下未解释余波；物件与身体状态必须连续。",
        "绝对禁止：把规划、审稿、因果清单或主题翻译成说明段，改写用户硬锚，或用好奇和事后补救冒充主动选择。",
    ),
    "blind-reader": (
        "可以认可：先判断人物欲望是否进入动作、关系和代价；选择留下私人余波，读完仍想追问人物而不只追谜底。",
        "慎判：专业、精确、强钩子和漂亮句子可能只是技术表演；警惕漂亮结论替代现场余波，并核对人物是否可替换。",
        "允许：克制、留白、误判、纯对白和不整齐节奏；不能因为没解释完整就判错。",
        "绝对不能 pass：物件或位置状态矛盾、主角没有主动选择、完美证据替代因果、控制面语言或修补接缝进入正文。",
    ),
    "chapter-editor": (
        "可以保留：偏离规划但显著增强人物、因果或收束的现场发现；必须明确说明收益与新增风险。",
        "慎审：完美证据链、因果跳步、机械精确、连续同主语和职业证明；逐步核对物理可行性与知识来源。",
        "允许：人物不知道、说错、犹豫和留白；Scene Package 只能发现缺失，不能证明正文已经交付。",
        "绝对禁止通过：用户硬锚合同优先于 Scene Package；用户硬锚漂移，或时间方向、金额或数量、物件位置、人物知识来源不一致，均不可通过。",
    ),
}
