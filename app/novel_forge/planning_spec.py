...
LITERARY_MICRO_RULES_VERSION = "literary-micro-rules/v2"
LITERARY_MICRO_RULES: dict[str, tuple[str, ...]] = {
    "writer": (
        "主动选择不能用好奇、观察或事后补救冒充；欲望必须进入动作、关系变化和可见代价。",
        "专业细节和精确数字只在改变动作、限制、风险或后果时出现；允许误判、迟疑、遮掩和说不尽。",
        "具体代价必须落到某个人、记忆、关系或物件；状态会变化的灯、门、工具和位置必须前后一致。",
        "禁止把规划、因果链、替代解释或主题翻译成说明段；守住硬锚、停止点和钩子，不改成方便版本。",
    ),
    "blind-reader": (
        "先判断人物欲望是否进入动作、关系和代价，再判断谜题、专业性或悬念是否成立。",
        "核对灯、门、手中物、人物位置等状态变化；能复述场面不等于动作真的连续。",
        "警惕装饰性精确数字、通用冷静能人、职业证明、规划清单和漂亮结论替代现场余波。",
        "局部句子好看不等于有人味；必须有身体、关系摩擦、可能出错的判断和选择后的残留。",
    ),
    "chapter-editor": (
        "用户硬锚合同优先于 Scene Package；规划和正文都不得改写时间方向、金额或数量、物件位置、人物知识来源、核心冲突和章末钩子。",
        "像核对状态机一样逐步核对时序、空间、灯与按键、物件去向、人物知识边界和不可逆动作。",
        "规划中的具体私人代价、关系余波和停止点若被正文抽象化或越过，必须判断是有效改进还是交付缺失。",
        "检查控制面翻译、装饰性精确数字、通用冷静能人和修补接缝；每轮全文重读并一次列全当前 MUST。",
    ),
}
